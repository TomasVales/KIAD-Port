...
export const MacbookScroll = ({
    ...
    return (
        <div
        ref={ref}
        className="flex min-h-[200vh] shrink-0 scale-[0.40] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-60 xl:scale-100 md:pb-80 md:pt-60">
        <motion.h2
            style={{
            translateY: textTransform,
            opacity: textOpacity,
            }}
            className="mb-30 text-center text-7xl md:text-4xl font-bold font-montserrat text-white">
            {title}
        </motion.h2>
        <Lid
            src={src}
...
const Logo = () => {
    return (
        <img src="/Logo.webp" alt="Logo" className="h-12" loading="lazy" />
    );
};
